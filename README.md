...
## **🔗 링크**
### 📌 웹페이지 - [**바로가기**](https://www.moviepjo.com/)
...
> 프로젝트를 하며 프론트엔드, 백엔드에 대해 배울 수 있었습니다. 목표로 한 기간보다 조금 오래 걸렸지만 팀원과 함께 완성할 수 있어서 좋았습니다. 프로젝트는 개개인의 능력보단 팀원과의 소통과 역할 분담을 통해 해낼 수 있다는 것을 깨달았습니다. git에 대해 초반에 중요하게 생각안하고 프로젝트에 들어간게 아쉬웠고 팀원이 친구다 보니 소통에 대해서는 편한 것이 좋았고, 서로 짠 코드에 대해 리뷰도 중요했던것 같습니다.
